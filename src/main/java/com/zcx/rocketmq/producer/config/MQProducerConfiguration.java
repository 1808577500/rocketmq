...
import com.zcx.rocketmq.producer.service.MQProducerTransactionCheckListener;
...
public class MQProducerConfiguration {
    ...
    public TransactionMQProducer  getTransactionMQProducer() throws RocketMQException {
        ...
        producer = new TransactionMQProducer(this.groupName + "-transaction");
        TransactionListener transactionCheckListener = new MQProducerTransactionCheckListener();
        producer.setNamesrvAddr(this.namesrvAddr);
        producer.setCreateTopicKey("AUTO_CREATE_TOPIC_KEY");
